...
@named ADM1_sys_hr = ADM1_factory()
ADM1_simp_hr = structural_simplify(ADM1_sys_hr)
#--------------------------------------------------------------------------------------
...
u0_d_hr=[S_su=>0.012394,S_aa=>0.0055432,S_fa=>0.10741,S_va=>0.012333,
...
prob_hr = ODEProblem(ADM1_simp_hr,u0_d_hr,tspan_hr,param_val)
...
tol_hr=1e-12; #Problem requires high tolerance for accurate dynamic solutions
@time sol_hr = solve(prob_hr, RadauIIA5(),abstol=tol_hr,reltol=tol_hr,saveat=(1/96))