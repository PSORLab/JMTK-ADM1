...
using DelimitedFiles,DataInterpolations,BenchmarkTools
...
#--------------------------------------------------------------------------------------
#DEFINE PARAMETERS AND VARIABLES IN GLOBAL NAMESPACE
#Define Influent Parameters
@parameters S_su_in,S_aa_in,S_fa_in,S_va_in,S_bu_in,S_pro_in,S_ac_in,S_h2_in,S_ch4_in,S_IC_in,S_IN_in,S_I_in,
X_c_in,X_ch_in,X_pr_in,X_li_in,X_su_in,X_aa_in,X_fa_in,X_c4_in,X_pro_in,X_ac_in,X_h2_in,X_I_in,S_cat_in,S_an_in
#Define Operating Parameters
@parameters q, V_liq, V_gas,T_op
...
I_pH_aa(t),I_pH_ac(t),I_pH_h2(t),I_IN_lim(t),I_h2_fa(t),I_h2_c4(t),I_h2_pro(t),I_nh3(t),I_5_6(t),I_7(t),I_8_9(t),I_10(t),I_11(t),I_12(t),subsum(t)
...
function ADM1_factory(;name)
    #DEFINE PARAMETERS AND VARIABLES IN LOCAL NAMESPACE
    #Define Influent Parameters
    @parameters S_su_in,S_aa_in,S_fa_in,S_va_in,S_bu_in,S_pro_in,S_ac_in,S_h2_in,S_ch4_in,S_IC_in,S_IN_in,S_I_in,X_c_in,X_ch_in,X_pr_in,X_li_in,X_su_in,X_aa_in,X_fa_in,X_c4_in,X_pro_in,X_ac_in,X_h2_in,X_I_in,S_cat_in,S_an_in
    #Define Operating Parameters
    @parameters q, V_liq, V_gas,T_op
    #Define Physical Conditions
    @parameters P_atm, R, p_gas_h2o
    ...
    #Define yields of biomass on substrate
    @parameters Y_su,Y_aa,Y_fa,Y_c4,Y_pro,Y_ac,Y_h2
    #Define kinetic,physiochemical,and biochemical parameters
    @parameters k_dis,k_hyd_ch,k_hyd_pr,k_hyd_li,k_dec_all,k_m_su,k_m_aa,k_m_fa,k_m_c4,k_m_pro,k_m_ac,k_m_h2,k_p,k_La
    @parameters K_S_IN,K_S_su,K_S_aa,K_S_fa,K_I_H2_fa,K_S_c4,K_I_H2_c4,K_S_pro,K_I_H2_pro,K_S_ac,K_I_NH3,K_S_h2,K_W,K_a_va,K_a_bu,K_a_pro,K_a_ac,K_a_co2,K_a_IN,K_H_co2,K_H_ch4,K_H_h2
    #Define pH limits
    @parameters pH_UL_aa,pH_LL_aa,pH_UL_ac,pH_LL_ac,pH_UL_h2,pH_LL_h2
...
#Influent parameters
influent_param=[S_su_in=>0.01,S_aa_in=>0.001,S_fa_in=>0.001,S_va_in=>0.001,S_bu_in=>0.001,S_pro_in=>0.001,S_ac_in=>0.001,S_h2_in=>1e-8,S_ch4_in=>1e-5,S_IC_in=>0.04,S_IN_in=>0.01,S_I_in=>0.02,
X_c_in=>2.0,X_ch_in=>5.0,X_pr_in=>20.0,X_li_in=>5.0,X_su_in=>0.0,X_aa_in=>0.01,X_fa_in=>0.01,X_c4_in=>0.01,X_pro_in=>0.01,X_ac_in=>0.01,X_h2_in=>0.01,X_I_in=>25.0,
S_cat_in=>0.04,S_an_in=>0.02]
#Size parameters
size_param=[q=>170.0,V_liq=>3400.0,V_gas=>300.0]
...
param_val=[influent_param;size_param; op_param; C_param; f_param; N_param; Y_parama; k_param; K_param; pH_param]
#--------------------------------------------------------------------------------------
#Define simulation properties and run simulation
#Provide Timespan
tspan = (0.0,280.0)
#Provide initial conditions
#u0 is initial conditions from BSM2 Steady State Benchmarks
u0 = [S_su=>0.012,S_aa=>0.0053,S_fa=>0.099,S_va=>0.012,S_bu=>0.013,S_pro=>0.016,
S_ac=>0.2,S_h2=>2.30E-07,S_ch4=>0.055,S_IC=>0.15,S_IN=>0.13,S_I=>0.33,
X_c=>0.31,X_ch=>0.028,X_pr=>0.1,X_li=>0.029,X_su=>0.42,X_aa=>1.18,X_fa=>0.24,
X_c4=>0.43,X_pro=>0.14,X_ac=>0.76,X_h2=>0.32,X_I=>25.6,
S_cat=>0.04,S_an=>0.02,S_H_plus=>0.00000003423,
S_gas_h2=>1.02e-05,S_gas_ch4=>1.63,S_gas_co2=>0.014]
...
tol=1e-6; #Problem requires medium tolerance for accurate solution
...
function plot_states(sol,states,t_r)
    ...
    for var in states
        ...
        savefig(temp,".\\StaticStatePlots\\var$(i)$(var).png");
    end
end
...
save_dat ? writedlm("MTK_ADM1sol_s.csv",save_sol(sol),",") : nothing